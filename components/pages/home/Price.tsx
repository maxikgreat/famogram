  ...
  return (
    <section className="fabrx-section bg-white mt-5">
      <div className="container">
        <div className="row">
          <div className="col-md-12 text-center mb-3 wow fadeInUp">
            <h2>Pricing plans</h2>
          </div>
        </div>
        <div className="row">
          <div className="col-lg-4 col-md-6 my-3 offset-lg-2 wow fadeInDown">
            <div className="card rounded-12 shadow-20">
              <div className="card-body p-0">
                <div className="plan-heading p-5 border-bottom rounded-top">
                  <div className="text-center">
                    ...
                    <span className="d-block font-size-14 pt-1">Starter</span>
                  </div>
                  <div className="plan-price"><span className="h3 font-weight-bold">$0</span> <span className="h6">/mo</span></div>
                </div>
                <ul className="fabrx-checks py-4 px-5 mb-0">
                  <li>Single domain</li>
                  <li>Single domain</li>
                  <li>Single domain</li>
                  <li>Single domain</li>
                ...
                <div className="pt-1 pb-5 text-center"><a href="#0" className="btn btn-lg btn-primary">Subscribe</a></div>
              </div>
            </div>
          </div>
            ...
            <div className="card rounded-12 shadow-20">
              <div className="card-body p-0">
                <div className="plan-heading p-5 border-bottom rounded-top">
                  ...
                  <div className="plan-price"><span className="h3 font-weight-bold">$20</span> <span className="h6">/mo</span></div>
                </div>
                <ul className="fabrx-checks py-4 px-5 mb-0">
                  <li>Single domain</li>
                  <li>Single domain</li>
